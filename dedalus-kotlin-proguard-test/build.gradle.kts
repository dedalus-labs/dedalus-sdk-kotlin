...
dependencies {
    testImplementation(project(":dedalus-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../dedalus-kotlin-core/src/main/resources/META-INF/proguard/dedalus-kotlin-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../dedalus-kotlin-core/src/main/resources/META-INF/proguard/dedalus-kotlin-core.pro",
