...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.dedalus_sdk.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.dedalus_sdk.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.dedalus_sdk.api.** {
    <init>(...);
